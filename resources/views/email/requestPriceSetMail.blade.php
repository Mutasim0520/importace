            ...
            <div class="panel-default" style="background-color: ghostwhite;">
                ...
                <div class="panel-body" style="padding: 10px;">
                    <p style="text-align: justify; font-size: 14px;">
                        The price of your requested item is updated.<strong>Request No: <span style="color:green">REQ_{{$latest_request->id}}</span></strong>.Price:<span style="color:green">{{$latest_request->price}} tk</span>
                    </p>
